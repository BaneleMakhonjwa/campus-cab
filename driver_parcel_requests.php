...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($parcelID <= 0) {
        ...
        if ($passengerStmt) {
            ...
            $passengerResult =
                $passengerStmt->get_result();

            if ($passengerRow =
                $passengerResult->fetch_assoc()) {

                $studentID =
                    (int)($passengerRow['studentID'] ?? 0);

                $staffID =
                    (int)($passengerRow['staff_id'] ?? 0);
            }
        ...
        if ($action === 'accept') {
            ...
            if ($stmt) {
                ...
                if (
                    ...
                    $notificationMessage =
                        "Your parcel request has been accepted by a driver.";
            ...
            if ($stmt) {
                ...
                if (
                    ...
                    $notificationMessage =
                        "Your parcel has been picked up by the driver.";
                    ...
                    $message =
                        "Unable to mark this parcel as picked up.";
        ...
        } elseif ($action === 'transit') {

            $stmt = $conn->prepare("
                UPDATE parcel
                SET parcel_status = 'In Transit'
                WHERE parcel = ?
                  AND DriverID = ?
                  AND parcel_status = 'Picked Up'
            ");
            ...
            if ($stmt) {
                ...
                if (
                    ...
                    $notificationMessage =
                        "Your parcel is now in transit to the destination.";
                    ...
                    $message =
                        "Unable to start transit for this parcel.";
            ...
            if ($stmt) {
                ...
                if (
                    ...
                    $message =
                        "Unable to mark this parcel as delivered.";
            ...
            if ($stmt) {
                ...
                if (
                    ...
                    $notificationMessage =
                        "Your parcel delivery has been cancelled by the driver.";
                    ...
                    $message =
                        "Unable to cancel this delivery.";
...
function getPassengerName($parcel)
{
    $studentName = trim(
        ($parcel['StudentFname'] ?? '') . ' ' .
        ($parcel['StudentLname'] ?? '')
                ...
                <?php foreach ($activeParcels as $parcel): ?>
                    ...
                    <div class="parcel-card">
                        ...
                        <div class="actions">
                            ...
                            <?php elseif (
                                $parcel['parcel_status'] === 'Picked Up'
                            ): ?>
                                ...
                                <form method="POST">
                                    ...
                                    <button
                                        type="submit"
                                        class="action-button transit-button"
                                    >
                                        Start Transit
                                    </button>
